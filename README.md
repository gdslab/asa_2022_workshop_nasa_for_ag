...
* Are there applications that are ready to use by crop consultants etc to make recommendations to farmers? Is there training available in these?
     ...
     * NASA Water Portal interactive catalogs of Water Data Needs and NASA Water-Related Capabilities, as part of our mission to improve how water is managed in the arid western U.S. by getting NASA data, technology, and tools into the hands of water managers and decision makers. The portal serves as a hub for building connections between these catalogs and our partners, including water managers, decision makers, and scientists.
